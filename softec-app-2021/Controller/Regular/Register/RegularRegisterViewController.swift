...
//        }
        ...
        if (screenView.nameTextField.hasText && screenView.numberTextField.hasText && screenView.addressTextField.hasText) {
            if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "RegularHomeViewController") as? RegularHomeViewController {
